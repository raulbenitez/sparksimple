...
for ii=1:length(tkl)
    ...
    cb=textIm(rg(4)+1,tk(ii),[niceNums(tkl(ii),dec)],cb,'fontsize',fs,'textcolor',tc,'horizontalalignment','left','verticalalignment','mid','blending',bl);%,'background','box','bgcolor',1,'bdcolor',0);
end